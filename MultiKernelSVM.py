...
class MultiKernelSVM():
    ...
    def __init__(self):
        ...
        self.df = pd.read_csv(r"C:\Users\User\Documents\New folder\GreyWolfOptimization-MKSVM\dataset\php3YXJ45.csv")
...
def classify(X , Y, l):
    ...
    for temp in l:
        if (temp==0):
            X_temp = X.drop(keys[i],axis=1)  #if l=[0,0,1,1,...,1] #24 values in total
